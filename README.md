> 🌍 [Français](README.fr.md) · **English** · [中文](README.zh.md) · [हिन्दी](README.hi.md) · [Español](README.es.md) · [العربية](README.ar.md)
...
The repository ships a ready-to-use example in [`data/`](data/README.md): one
...
**File provenance** (details in [data/README.md](data/README.md)):
...
> meaning. See [data/README.md](data/README.md).
