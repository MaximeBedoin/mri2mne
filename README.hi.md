...
* **`irm2mne`** — सब कुछ संचालित करता है (यह रिपॉज़िटरी)। `simnibs` को **कभी** import
  नहीं करता।
* **`simnibs_env`** — SimNIBS 4.6 + MNE। SimNIBS-विशिष्ट चरण चलाता है, जिन्हें
  `irm2mne` **सबप्रोसेस** के रूप में बुलाता है।
...
environment.yml            irm2mne वातावरण (संचालक)
src/mri2mne/
